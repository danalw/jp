...
3) find whole sentences with problematic tokens inside of udpipe_temp (contains tokens with id in format \d-\d),
  and extract -> edited/ (before)
4) edit sentences and generate new d tree  http://lindat.mff.cuni.cz/services/parsito/api/parse -> edited/#_parsito_ (after)
